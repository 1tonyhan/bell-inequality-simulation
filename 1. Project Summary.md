...
**Figure 1: 3 Axes to measure spin along; For simplicity, each axis is in the same plane, and separated by $120^{\circ}$**
...
**insert photo of bloch sphere coordinate system here**
